package cazimir.com.magazoo.constants;
...
public class Constants {
    ...
    public static final String REPORT_247 = "nonstop";
    public static final String REPORT_TICKETS = "tickets";
    ...
    public static final String PASSWORD_NA = "no password";
